<template>
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="loadMoreShow=true" v-if="!nickName">Login</a>
          <a href="javascript:void(0)" class="navbar-link" v-if="nickName" @click="logOut">Logout</a>
          <div class="navbar-cart-container">
            <span class="navbar-cart-count" v-if="cartCount>0">{{cartCount}}</span>
            <router-link class="navbar-link navbar-cart-link" href="javascript:;" to="/cart">
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':loadMoreShow}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">Login in</div>
          <button class="md-close" @click="loadMoreShow=false">Close</button>
        </div>
          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                ...
                <input v-model="userName" placeholder="用户名" type="text" tabindex="1" maxlength="32" name="loginname" class="regi_login_input">
              </li>
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input @keyup.enter="login" v-model="userPwd" placeholder="密  码" type="password" tabindex="2" maxlength="32" name="password" class="regi_login_input">
              </li>
            </ul>
          </div>
    ...
    <div class="md-overlay" v-if="loadMoreShow" @click="loadMoreShow=false"></div>
  </header>
</template>
  ...
  export default {
    data () {
      return {
        userName:'',  //保存用户名
        userPwd:'',   //保存密码
        errorTip:false, //是否显示错误提示
        loadMoreShow:false, //登录模态框是否显示
        //nickName:'' //保存登录成功后的用户名
      }
    },
    computed:{
